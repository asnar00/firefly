...
export class Graph {
    constructor(container) {
        ...
        this.focusNode = null; // fixed node around which all others are arranged
    ...
    // create a new node from a div, or return existing
    ...
    sortNodesIntoColumns() {
        ...
        this.columns.addNode(this.focusNode, 0);
        this.focusNode.sortIndex = "000";
        this.focusNode.visit();
        this.forwardPassRec(this.focusNode);
        this.backwardPassRec(this.focusNode);
